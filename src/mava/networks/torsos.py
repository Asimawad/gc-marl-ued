...
class SwiGLU(nn.Module):
    ...
    def setup(self) -> None:
        self.W_linear = self.param("W_linear", nn.initializers.zeros, (self.embed_dim, self.hidden_dim))
        self.W_gate = self.param("W_gate", nn.initializers.zeros, (self.embed_dim, self.hidden_dim))
        self.W_output = self.param("W_output", nn.initializers.zeros, (self.hidden_dim, self.embed_dim))
