...
class Observation(NamedTuple):
    ...
    # achieved_goal: Optional[chex.Array] = None  # (num_agents, goal_dim)
    # ultimate_goal: Optional[chex.Array] = None  # (num_agents, goal_dim)
    # episode_id: Optional[chex.Array] = None  # (num_agents, )

class ObservableMarlEnv(MarlEnv, Protocol):
    def observe(self, state: State) -> TimeStep[Observation]:
...
RNNGlobalObservation: TypeAlias = Tuple[Union[ObservationGlobalState, "GraphObservation[ObservationGlobalState]"], Done]
...
RecActorApply = Callable[[FrozenDict, HiddenState, RNNObservation], Tuple[HiddenState, Distribution]]
