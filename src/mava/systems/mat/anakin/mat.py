...
def get_learner_fn(
    ...
    def _update_step(learner_state: LearnerState, _: Any) -> Tuple[LearnerState, Tuple]:
        ...
        def _env_step(learner_state: LearnerState, _: Any) -> Tuple[LearnerState, Tuple[PPOTransition, Metrics]]:
            ...
            transition = PPOTransition(done, action, value, timestep.reward, log_prob, last_timestep.observation)
        ...
        def _calculate_gae(traj_batch: PPOTransition, last_val: chex.Array) -> Tuple[chex.Array, chex.Array]:
            """Calculate the GAE."""
