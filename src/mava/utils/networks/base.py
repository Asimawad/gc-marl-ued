...
class FeedForwardActor(nn.Module):
    ...
    @nn.compact
    def __call__(self, observation: Union[Observation, GraphObservation[Observation]]) -> tfd.Distribution:
        """Forward pass."""
...
class RecurrentActor(nn.Module):
    ...
    def __call__(
        ...
        policy_hidden_state, policy_embedding = ScannedRNN(self.hidden_state_dim)(policy_hidden_state, policy_rnn_input)
