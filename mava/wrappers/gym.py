...
class UoeWrapper(gymnasium.Wrapper):
    ...
    def __init__(
        ...
        local_observation_space = spaces.Box(low=low, high=high, shape=shape, dtype=single_obs.dtype)
        ...
        if add_global_state:
            ...
            global_observation_space = spaces.Box(low=low, high=high, shape=shape, dtype=single_obs.dtype)
...
class GymAgentIDWrapper(gymnasium.Wrapper):
    ...
    def __init__(self, env: gymnasium.Env):
        ...
        self.observation_space["agents_view"] = self.modify_space(self.env.observation_space["agents_view"])
