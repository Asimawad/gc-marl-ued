...
class GraphMultiHeadAttentionLayer(nn.Module):
    ...
    def __call__(self, graph: JraphGraphsTuple) -> JraphGraphsTuple:
        ...
        def compute_messages_fn(
            ...
            weights = jraph_utils.segment_softmax(logits, segment_ids=graph.receivers, num_segments=sum_n_node)
...
def get_ego_node_features(graph: JraphGraphsTuple, ego_node_index: chex.Array, *num_nodes: Sequence[int]) -> chex.Array:
