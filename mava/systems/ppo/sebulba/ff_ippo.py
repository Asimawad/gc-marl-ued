    ...
    def _update_step(
        ...
        def _update_epoch(update_state: Tuple, _: Any) -> Tuple[Tuple, Metrics]:
            ...
            def _update_minibatch(train_state: Tuple, batch_info: Tuple) -> Tuple:
                ...
                def _critic_loss_fn(critic_params: FrozenDict, traj_batch: PPOTransition, targets: chex.Array) -> Tuple:
...
def learner_setup(
    ...
    params, opt_states, step_keys = jax.device_put((params, opt_states, step_keys), learner_sharding)
