...
def make_update_fns(
    ...
    def update_q(
        ...
        if cfg.system.hard_update:
            ...
            next_mixer_target_params = optax.incremental_update(next_mixer_params, params.mixer_target, cfg.system.tau)
    ...
    def train(train_state: TrainState[QMIXParams], _: Any) -> Tuple[TrainState[QMIXParams], Metrics]:
