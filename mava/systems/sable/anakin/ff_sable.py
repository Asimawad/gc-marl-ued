...
def get_learner_fn(
    ...
    def _update_step(learner_state: LearnerState, _: Any) -> Tuple[LearnerState, Tuple]:
        ...
        def _env_step(learner_state: LearnerState, _: int) -> Tuple[LearnerState, Tuple[Transition, Metrics]]:
...
def learner_setup(
    ...
    # Create fake hstates
    minibatch_size = config.arch.num_envs * config.system.rollout_length // config.system.num_minibatches
    ...
    apply_fns = (
        partial(sable_network.apply, method="get_actions", hstates=dummy_actor_hs),  # Execution function
