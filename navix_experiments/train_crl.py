...
if __name__ == "__main__":
    ...
    for seed in range(args.n_seeds):
        ...
        sa_encoder = sa_ConvEncoder(output_size=env.action_space.n * args.rep_size)
        sa_encoder_params = sa_encoder.init(sa_key, jnp.ones([1, *env.observation_space.shape]))
        ...
        def actor_step(training_state, env_state, g_repr, key, extra_fields):
            state = env_state.observation
            s_repr = sa_encoder.apply(training_state.critic_state.params["sa_encoder"], state).reshape(-1, action_size, args.rep_size)
        ...
        def get_experience(training_state, env_state, buffer_state, key):
            ...
            def f(carry, unused_t):
                ...
                training_state, env_state, transition = actor_step(training_state, env_state, g_repr, current_key, extra_fields=("seed",))
