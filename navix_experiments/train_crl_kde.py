...
if __name__ == "__main__":
    ...
    for seed in range(args.n_seeds):
        ...
        # # DEBUG:
        # env2 = nx.make("Navix-DoorKey-6x6-v0")
        # print('env2.max_steps:', env2.max_steps)
        ...
        def get_experience(training_state, transitions, env_state, buffer_state, key):
            ...
            def f(carry, unused_t):
                ...
                training_state, env_state, transition = actor_step(training_state, env_state, explore_goal_reps, explore_goals, current_key, extra_fields=("seed",))
